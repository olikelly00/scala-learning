...
class FizzBuzzTest extends AnyFunSuite {
  ...
  test("lists the numbers up to first fizz") {
    assert(FizzBuzz.generate(3) === "1, 2, Fizz")
  }

  test("lists the numbers up to first buzz") {
    assert(FizzBuzz.generate(5) === "1, 2, Fizz, 4, Buzz")
  }

  test("lists numbers / fizz-buzzes correctly up to 15") {
    assert(FizzBuzz.generate(15) === "1, 2, Fizz, 4, Buzz, Fizz, 7, 8, Fizz, Buzz, 11, Fizz, 13, 14, FizzBuzz")
  }

  test("lists numbers / fizz-buzzes correctly up to 100") {
  ...
  test("Functional - lists the numbers up to one") {
    assert(FunctionalFizzBuzz.generate(1) === "1")
  }

  test("Functional - lists the numbers up to two") {
    assert(FunctionalFizzBuzz.generate(2) === "1, 2")
  }

  test("Functional - lists the numbers up to first Fizz") {
    assert(FunctionalFizzBuzz.generate(3) === "1, 2, Fizz")
  }

  test("Functional - lists the numbers up to first Buzz") {
    assert(FunctionalFizzBuzz.generate(5) === "1, 2, Fizz, 4, Buzz")
  }

  test("Functional - lists the numbers up to 15") {
    assert(FunctionalFizzBuzz.generate(15) === "1, 2, Fizz, 4, Buzz, Fizz, 7, 8, Fizz, Buzz, 11, Fizz, 13, 14, FizzBuzz")
  }
